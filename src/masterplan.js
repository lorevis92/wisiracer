...
export function buildMasterplan(scene,curve,art){
 ...
 landmarks.forEach(([n,x,y,h,w,d])=>{if(n==="THE RED FOX"||AUTHORED_LANDMARKS.some(a=>a.name===n))return;box(n,x,y,0,w/CITY_SCALE,d/CITY_SCALE,h,red);sign(n,x,y,h+3);});
 AUTHORED_LANDMARKS.forEach((_,i)=>buildAuthoredLandmark(scene,i,{stone:art?.stone||stone}));
